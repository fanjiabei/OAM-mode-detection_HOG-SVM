# -*- coding: utf-8 -*-
#step3的改进，添加循环,需手动改的地方有两处：mode_num赋值以及scipy.misc.imsave路径中
...
#scipy.misc.toimage(imgRotation, cmin=0.0, cmax=255).save('outfile2.jpg')
 scipy.misc.imsave('D:/Subject experiment/Experiment 1_data augmentation/result/l=4/presolve/rotation/'+'modenum_'+str(mode_num)+'_rotate'+str(angle)+'°.jpg', imgRotation)
 angle=30+i*30
#  cv2.imshow("img",img) 
